disease_dic = {
    'Apple___Apple_scab': """ <br/>Disease: Scab<br/>
        <br/> Cause of disease:

        <br/><br/> 1. Scab overwinters primarily in fallen leaves and in the soil. Disease development is favored by wet, cool weather that generally occurs in spring and early summer.

        <br/> 2. Fungal spores are carried by wind, rain or splashing water from the ground to flowers, leaves or fruit. During damp or rainy periods, newly opening leaves are extremely susceptible to infection. The longer the leaves remain wet, the more severe the infection will be. Scab spreads rapidly between 55-75 degrees Fahrenheit.
    ...
    'Apple___Black_rot': """  <br/>Disease: Black Rot<br/>
        <br/> Cause of disease:
    ...
    'Apple___healthy': """  <br/>Disease: No disease<br/>
    ...
    'Blueberry___healthy': """  <br/>Disease: No disease<br/>
    ...
    'Cherry_(including_sour)___Powdery_mildew': """  <br/>Disease: Powdery Mildew<br/>
        <br/> Cause of disease:
    ...
    'Cherry_(including_sour)___healthy': """  <br/>Disease: No disease<br/>
    ...
    'Grape___Leaf_blight_(Isariopsis_Leaf_Spot)': """ <br/> Disease: Leaf Spot""",


    'Orange___Haunglongbing_(Citrus_greening)': """  <br/>Disease: Citrus Greening<br/>
        <br/> Cause of disease:
    ...
    'Peach___Bacterial_spot': """  <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Pepper,_bell___Bacterial_spot': """  <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Peach___healthy': """  <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Pepper,_bell___healthy': """  <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",


    'Potato___healthy': """  <br/>Disease: No disease<br/>

        <br/><br/> Don't worry. Your crop is healthy. Keep it up !!!""",

    'Raspberry___healthy': """  <br/>Disease: No disease<br/>
    ...
    'Potato___Early_blight': """  <br/>Disease: Early Blight<br/>
        <br/> Cause of disease:
    ...
    'Potato___Late_blight': """  <br/>Disease: Late Blight<br/>
    ...
    'Squash___Powdery_mildew': """  <br/>Disease: Powdery mildew<br/>
        <br/> Cause of disease:
    ...
    'Strawberry___Leaf_scorch': """  <br/>Disease: Leaf Scorch<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Bacterial_spot': """  <br/>Disease: Bacterial Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Early_blight': """  <br/>Disease: Early Blight<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Late_blight': """  <br/>Disease: Late Blight<br/>
    ...
    'Tomato___Leaf_Mold': """  <br/>Disease: Leaf Mold<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Septoria_leaf_spot': """  <br/>Disease: Leaf Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Spider_mites Two-spotted_spider_mite': """  <br/>Disease: Two-spotted spider mite<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Target_Spo': """  <br/>Disease: Target Spot<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Tomato_Yellow_Leaf_Curl_Virus': """  <br/>Disease: Yellow Leaf Curl Virus<br/>
        <br/> Cause of disease:
    ...
    'Tomato___Tomato_mosaic_virus': """  <br/>Disease: Mosaic Virus<br/>
        <br/> Cause of disease:

        <br/><br/> 1.  mosaic virus and tobacco mosaic virus can exist for two years in dry soil or leaf debris, but will only persist one month if soil is moist. The viruses can also survive in infected root debris in the soil for up to two years.
